...
/* We run with %pKil set to PIL_NORMAL_MAX and PSTATE_IE enabled in %pKstate.
...
void sun4v_itlb_error_report(struct pt_regs *regs, int tl)
{
	...
	printk(KERN_EMERG "SUN4V-ITLB: Error at TPC[%lx], tl %d\n",
	       regs->tpc, tl);
	printk(KERN_EMERG "SUN4V-ITLB: TPC<%pKS>\n", (void *) regs->tpc);
	printk(KERN_EMERG "SUN4V-ITLB: O7[%lx]\n", regs->u_regs[UREG_I7]);
	printk(KERN_EMERG "SUN4V-ITLB: O7<%pKS>\n",
...
void sun4v_dtlb_error_report(struct pt_regs *regs, int tl)
{
	...
	printk(KERN_EMERG "SUN4V-DTLB: Error at TPC[%lx], tl %d\n",
	       regs->tpc, tl);
	printk(KERN_EMERG "SUN4V-DTLB: TPC<%pKS>\n", (void *) regs->tpc);
	printk(KERN_EMERG "SUN4V-DTLB: O7[%lx]\n", regs->u_regs[UREG_I7]);
	printk(KERN_EMERG "SUN4V-DTLB: O7<%pKS>\n",
	       (void *) regs->u_regs[UREG_I7]);
