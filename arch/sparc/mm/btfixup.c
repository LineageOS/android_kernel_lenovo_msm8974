...
static char wrong_f[] __initdata = "Trying to set f fixup %pK to invalid function %08x\n";
static char wrong_b[] __initdata = "Trying to set b fixup %pK to invalid function %08x\n";
static char wrong_s[] __initdata = "Trying to set s fixup %pK to invalid value %08x\n";
static char wrong_h[] __initdata = "Trying to set h fixup %pK to invalid value %08x\n";
static char wrong_a[] __initdata = "Trying to set a fixup %pK to invalid value %08x\n";
static char wrong[] __initdata = "Wrong address for %c fixup %pK\n";
static char insn_f[] __initdata = "Fixup f %pK refers to weird instructions at %pK[%08x,%08x]\n";
static char insn_b[] __initdata = "Fixup b %pK doesn't refer to a SETHI at %pK[%08x]\n";
static char insn_s[] __initdata = "Fixup s %pK doesn't refer to an OR at %pK[%08x]\n";
static char insn_h[] __initdata = "Fixup h %pK doesn't refer to a SETHI at %pK[%08x]\n";
static char insn_a[] __initdata = "Fixup a %pK doesn't refer to a SETHI nor OR at %pK[%08x]\n";
static char insn_i[] __initdata = "Fixup i %pK doesn't refer to a valid instruction at %pK[%08x]\n";
static char fca_und[] __initdata = "flush_cache_all undefined in btfixup()\n";
static char wrong_setaddr[] __initdata = "Garbled CALL/INT patch at %pK[%08x,%08x,%08x]=%08x\n";
