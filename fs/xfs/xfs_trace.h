...
DECLARE_EVENT_CLASS(xfs_attr_list_class,
	...
	TP_printk("dev %d:%d ino 0x%llx cursor h/b/o 0x%x/0x%x/%u dupcnt %u "
		  "alist 0x%pK size %u count %u firstu %u flags %d %s",
...
DECLARE_EVENT_CLASS(xfs_perag_class,
	...
	TP_printk("dev %d:%d agno %u refcount %d caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->agno,
		  __entry->refcount,
...
TRACE_EVENT(xfs_iext_insert,
	...
	TP_printk("dev %d:%d ino 0x%llx state %s idx %ld "
		  "offset %lld block %lld count %lld flag %d caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->ino,
...
TRACE_EVENT(xfs_buf_ioerror,
	...
	TP_printk("dev %d:%d bno 0x%llx len 0x%zx hold %d pincount %d "
		  "lock %d error %d flags %s caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  (unsigned long long)__entry->bno,
		  __entry->buffer_length,
		  __entry->hold,
...
DECLARE_EVENT_CLASS(xfs_lock_class,
	...
	TP_printk("dev %d:%d ino 0x%llx flags %s caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->ino,
...
DECLARE_EVENT_CLASS(xfs_iref_class,
	...
	TP_printk("dev %d:%d ino 0x%llx count %d pincount %d caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->ino,
		  __entry->count,
		  __entry->pincount,
...
DECLARE_EVENT_CLASS(xfs_log_item_class,
	...
	TP_printk("dev %d:%d lip 0x%pK lsn %d/%d type %s flags %s",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->lip,
...
TRACE_EVENT(xfs_trans_commit_lsn,
	...
	TP_printk("dev %d:%d trans 0x%pK commit_lsn 0x%llx",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->tp,
		  __entry->lsn)
);
...
TRACE_EVENT(xfs_agf,
	...
	TP_printk("dev %d:%d agno %u flags %s length %u roots b %u c %u "
		  ...
		  "freeblks %u longest %u caller %pKf",
		  MAJOR(__entry->dev), MINOR(__entry->dev),
		  __entry->agno,
...
DECLARE_EVENT_CLASS(xfs_log_recover_item_class,
	...
	TP_printk("dev %d:%d trans 0x%x, pass %d, item 0x%pK, item type %s "
