...
TRACE_EVENT(timer_start,
	...
	TP_printk("timer=%pK function=%pKf expires=%lu [timeout=%ld] defer=%c",
...
TRACE_EVENT(timer_expire_entry,
	...
	TP_printk("timer=%pK function=%pKf now=%lu", __entry->timer, __entry->function,__entry->now)
);
...
TRACE_EVENT(hrtimer_start,
	...
	TP_printk("hrtimer=%pK function=%pKf expires=%llu softexpires=%llu",
...
TRACE_EVENT(hrtimer_expire_entry,
	...
	TP_printk("hrtimer=%pK function=%pKf now=%llu", __entry->hrtimer, __entry->function,
