...
#if LAPB_DEBUG > 2
	printk(KERN_DEBUG "lapb: (%pK) S%d RX %02X %02X %02X\n",
	       lapb->dev, lapb->state,
...
#if LAPB_DEBUG > 1
	printk(KERN_DEBUG "lapb: (%pK) S%d TX FRMR %02X %02X %02X %02X %02X\n",
	       lapb->dev, lapb->state,
...
#if LAPB_DEBUG > 1
	printk(KERN_DEBUG "lapb: (%pK) S%d TX FRMR %02X %02X %02X\n",
